    ...
    if (htmlele_ instanceof Data_Maybe.Just) {
        return function __do() {
            ...
            var a = (function () {
                ...
                throw new Error("Failed pattern match at Main (line 85, column 27 - line 86, column 73): " + [ b.constructor.name ]);
            })();
            return a;
        };
    };
    throw new Error("Failed pattern match at Main (line 82, column 3 - line 87, column 28): " + [ htmlele_.constructor.name ]);
};
var toggleHidden_ = function (v) {
    ...
    throw new Error("Failed pattern match at Main (line 89, column 1 - line 89, column 46): " + [ v.constructor.name ]);
};
...
var getById = function (fallback) {
    return function (id) {
        return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))((function () {
            var $15 = Control_Applicative.pure(Effect.applicativeEffect);
            return function ($16) {
                return $15(Web_HTML_HTMLDocument.toNonElementParentNode($16));
            };
        })()))(Web_DOM_NonElementParentNode.getElementById(id)))((function () {
            var $17 = Data_Maybe.fromMaybe(Control_Applicative.pure(Effect.applicativeEffect)(fallback));
            var $18 = Data_Functor.map(Data_Maybe.functorMaybe)(Web_DOM_Node.textContent);
            var $19 = Data_Functor.map(Data_Maybe.functorMaybe)(Web_DOM_Element.toNode);
            return function ($20) {
                return $17($18($19($20)));
            };
        })());
...
var fadeToggle_ = function (v) {
    ...
    throw new Error("Failed pattern match at Main (line 54, column 1 - line 54, column 44): " + [ v.constructor.name ]);
};
...
// resolve _ = pure "ok"
var main = Effect_Aff.launchAff_(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
    var doc = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document)();
    var elem_ = Web_DOM_NonElementParentNode.getElementById("hide-elem")(Web_HTML_HTMLDocument.toNonElementParentNode(doc))();
    fadeToggle_(elem_)();
...
var fadeOut_ = function (v) {
    ...
    throw new Error("Failed pattern match at Main (line 74, column 1 - line 74, column 41): " + [ v.constructor.name ]);
};
...
var fadeIn_ = function (v) {
    ...
    throw new Error("Failed pattern match at Main (line 64, column 1 - line 64, column 40): " + [ v.constructor.name ]);
};
module.exports = {
